...
static NSString * const kGoogleAPIClientID = @"779186599842-pir1mnpn46ie3gdql278fb3pk40nlf3r.apps.googleusercontent.com";
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:[kGCAEventCellIdentifier copy]];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    _calendarService.authorizer = [GTMOAuth2ViewControllerTouch
                                   ...
                                   clientSecret:nil];
    NSLog(@"G Auth : %d",_calendarService.authorizer.canAuthorize);
...
- (void)launchGoogleAuthenticationView {
    ...
    closeButton.backgroundColor = [UIColor colorWithRed:255.0f/255.0f green:51.0f/255.0f blue:102.0f/255.0f alpha:1.0f];
